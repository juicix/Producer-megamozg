...
Assert-True ($skills.Count -eq 13) "Expected 13 skills, found $($skills.Count)"
...
Assert-True ($projectFiles.Count -eq 17) "Expected 17 Project files, found $($projectFiles.Count)"
